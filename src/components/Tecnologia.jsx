    ...
    <Container fluid className="tecnologia-container p-0">
      <Row className="m-0 p-0 container-fluid">
        ...
        <Col
          xs={12}
          md={6}
          className="p-0 d-flex justify-content-center back-tech"
        >
        ...
        <Col xs={12} md={6} className=" tecnologia-div container-fluid">
          <div className="container-fluid p-tech">
            <p>
              ...
              trazar las etapas de tu cultivo de canbis en tiempo real para
              lograr altos estandares de calidad, aportando a una mejor calidad
          ...
          <div className="container-fluid d-flex justify-content-center">
            <Image src={imagenTri} fluid className="img-tri" />
          </div>
        </Col>
      </Row>
    </Container>
